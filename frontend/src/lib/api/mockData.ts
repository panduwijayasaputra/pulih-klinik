...
import { ClientEducationEnum, ClientStatusEnum } from '@/types/enums';
  ...
  CLT003: [
    {
      ...
      therapistName: 'Dr. Ahmad Pratama (Multi-role)',
  ...
  CLT008: [
    {
      ...
      status: 'scheduled',
      durationMinutes: 60,
      notes: 'Sesi intake awal untuk assessment perfectionism dan work anxiety. Perlu evaluasi mendalam tentang pola pikir dan trigger.',
    },
  ],
  CLT009: [
    {
      ...
      status: 'completed',
      durationMinutes: 60,
      notes: 'Konsultasi awal untuk stres pasca perceraian. Klien melaporkan gejala depresi ringan, kesulitan tidur, dan masalah coping. Riwayat konseling pernikahan sebelumnya.',
      assessment: { 
        tool: 'PHQ-9', 
        preScore: 11, 
        scoreUnit: 'points', 
        notes: 'Skor menunjukkan depresi ringan-sedang. Gejala terkait adjustment disorder pasca perceraian.' 
      },
    },
    {
      id: 'sess-902',
      ...
      status: 'completed',
      durationMinutes: 60,
      notes: 'Induksi hipnosis untuk stress management dan emotional regulation. Klien responsif terhadap teknik relaksasi. Latihan breathing exercises dan progressive muscle relaxation.',
    },
  ],
  CLT010: [
    {
      ...
      status: 'completed',
      durationMinutes: 60,
      notes: 'Konsultasi awal untuk kecemasan sosial pada remaja. Klien mengalami kesulitan berinteraksi dengan teman sebaya di sekolah. Gejala: menghindari presentasi, takut dinilai, isolasi sosial.',
      assessment: { 
        tool: 'GAD-7', 
        preScore: 12, 
        scoreUnit: 'points', 
        notes: 'Skor menunjukkan kecemasan sedang. Gejala terfokus pada situasi sosial dan evaluasi dari orang lain.' 
      },
    },
    {
      id: 'sess-1002',
      ...
      status: 'completed',
      durationMinutes: 45,
      notes: 'Induksi hipnosis untuk confidence building. Latihan visualization dan positive self-talk. Klien merespons baik terhadap teknik guided imagery.',
    },
    {
      id: 'sess-1003',
      clientId: 'CLT010',
      ...
      status: 'completed',
      durationMinutes: 60,
      notes: 'Terapi exposure therapy untuk social anxiety. Latihan gradual exposure ke situasi sosial. Klien berhasil melakukan presentasi kecil di depan cermin.',
    },
  ],
  CLT011: [
    {
      ...
      status: 'scheduled',
      durationMinutes: 60,
      notes: 'Sesi intake awal untuk assessment social anxiety dan impostor syndrome. Perlu evaluasi mendalam tentang self-doubt dan fear of failure di lingkungan kerja.',
    },
  ],
  CLT007: [
    {
...
export const mockClients = [
  ...
  },
  {
    ...
    hobbies: 'Melukis, Fotografi, Traveling',
    maritalStatus: 'Single' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Indah Permata - +6288901234568 (Ibu)',
    firstVisit: true,
    previousVisitDetails: '',
    assignedTherapist: 'therapist-001',
    ...
    lastSession: '',
    progress: 0,
    notes: 'Klien baru ditugaskan, belum memulai sesi terapi. Keluhan utama: perfectionism dan anxiety dalam lingkungan kerja.',
    province: 'DKI Jakarta',
    // Minor-specific fields
    isMinor: false,
    school: undefined,
    ...
    age: 30,
    primaryIssue: 'Perfectionism & Work Anxiety',
    emergencyContactDetails: {
      name: 'Indah Permata',
      phone: '+6288901234568',
      relationship: 'Ibu'
  ...
  },
  {
    ...
    education: ClientEducationEnum.Bachelor,
    educationMajor: 'Manajemen Bisnis',
    address: 'Jl. Ahmad Yani No. 234, Bekasi',
    phone: '+6289012345678',
    email: 'rudi.hartono@email.com',
    hobbies: 'Badminton, Membaca, Investasi',
    maritalStatus: 'Divorced' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Hartono Wijaya - +6289012345679 (Ayah)',
    firstVisit: false,
    previousVisitDetails: 'Pernah mengikuti konseling pernikahan selama 6 bulan. Mengalami stres pasca perceraian dan kesulitan mengatur emosi.',
    assignedTherapist: 'therapist-001',
    status: ClientStatusEnum.Consultation,
    joinDate: '2024-01-30',
    totalSessions: 2,
    ...
    progress: 25,
    notes: 'Klien sedang dalam tahap konsultasi awal. Menunjukkan gejala depresi ringan dan kesulitan coping pasca perceraian.',
    province: 'Jawa Barat',
    // Minor-specific fields
    isMinor: false,
    school: undefined,
    ...
    name: 'Rudi Hartono',
    age: 36,
    primaryIssue: 'Stres Pasca Perceraian',
    emergencyContactDetails: {
      name: 'Hartono Wijaya',
      phone: '+6289012345679',
      relationship: 'Ayah'
  ...
  },
  {
    ...
    progress: 40,
    notes: 'Klien mengalami kecemasan sosial di sekolah. Responsif terhadap teknik relaksasi dan exposure therapy. Menunjukkan kemajuan dalam interaksi sosial.',
    province: 'DKI Jakarta',
    // Minor-specific fields
    isMinor: true,
  ...
  },
  {
    ...
    address: 'Jl. Pahlawan No. 567, Tangerang',
    phone: '+6290123456789',
    ...
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Anggara Wijaya - +6290123456790 (Ayah)',
    firstVisit: true,
    previousVisitDetails: '',
    assignedTherapist: 'therapist-001',
    status: ClientStatusEnum.Assigned,
    ...
    lastSession: '',
    progress: 0,
    notes: 'Klien baru ditugaskan. Keluhan utama: social anxiety dan impostor syndrome dalam lingkungan kerja. Perlu assessment lebih lanjut.',
    province: 'Banten',
    // Minor-specific fields
    isMinor: false,
    school: undefined,
    ...
    name: 'Dimas Anggara',
    age: 32,
    primaryIssue: 'Social Anxiety & Impostor Syndrome',
    emergencyContactDetails: {
      name: 'Anggara Wijaya',
      phone: '+6290123456790',
      relationship: 'Ayah'
  ...
  },
  {
    ...
    education: ClientEducationEnum.Bachelor,
    educationMajor: 'Komunikasi',
    address: 'Jl. Kemang Raya No. 88, Jakarta Selatan',
    phone: '+6291234567890',
    email: 'lestari.wulandari@email.com',
    hobbies: 'Fotografi, Traveling, Menulis Blog',
    maritalStatus: 'Single' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Wulan Sari - +6291234567891 (Ibu)',
    firstVisit: true,
    previousVisitDetails: '',
    assignedTherapist: 'multi-001',
    status: ClientStatusEnum.Consultation,
    ...
    progress: 15,
    notes: 'Klien mengalami anxiety dalam public speaking dan social media presence. Sedang dalam tahap konsultasi awal untuk menentukan treatment plan.',
    province: 'DKI Jakarta',
    // Minor-specific fields
    isMinor: false,
    school: undefined,
    ...
    age: 35,
    primaryIssue: 'Public Speaking Anxiety',
    emergencyContactDetails: {
      name: 'Wulan Sari',
      phone: '+6291234567891',
      relationship: 'Ibu'
  ...
  },
  {
    ...
    education: ClientEducationEnum.Master,
    educationMajor: 'Manajemen Proyek',
    address: 'Jl. Raya Darmo No. 156, Surabaya',
    phone: '+6292345678901',
    email: 'bayu.setiawan@email.com',
    hobbies: 'Cycling, Reading, Playing Guitar',
    maritalStatus: 'Married' as const,
    spouseName: 'Rina Anggraini',
    relationshipWithSpouse: 'Good' as const,
    emergencyContact: 'Rina Anggraini - +6292345678902 (Istri)',
    firstVisit: false,
    previousVisitDetails: 'Pernah mengikuti terapi CBT selama 3 bulan untuk mengatasi work burnout. Mengalami perbaikan signifikan namun kembali mengalami symptoms.',
    assignedTherapist: 'multi-001',
    status: ClientStatusEnum.Done,
    joinDate: '2024-01-15',
    totalSessions: 6,
    lastSession: '2024-02-08',
    progress: 90,
    notes: 'Klien telah menyelesaikan program terapi untuk work burnout. Menunjukkan kemajuan signifikan dalam stress management dan work-life balance.',
    province: 'Jawa Timur',
    // Minor-specific fields
    isMinor: false,
    school: undefined,
  ...
  },
  {
    ...
    education: ClientEducationEnum.Bachelor,
    educationMajor: 'Desain Grafis',
    address: 'Jl. Kaliurang No. 78, Yogyakarta',
    phone: '+6293456789012',
    email: 'anisa.rahma@email.com',
    hobbies: 'Digital Art, Gaming, Watching Movies',
    maritalStatus: 'Single' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Rahma Sari - +6293456789013 (Ibu)',
    firstVisit: true,
    previousVisitDetails: '',
    assignedTherapist: 'multi-001',
    status: ClientStatusEnum.Assigned,
    ...
    lastSession: '',
    progress: 0,
    notes: 'Klien baru ditugaskan. Keluhan utama: depression dan social withdrawal setelah putus dengan pacar. Perlu assessment awal dan intake session.',
    province: 'DI Yogyakarta',
    // Minor-specific fields
    isMinor: false,
    school: undefined,
    ...
    name: 'Anisa Rahma',
    age: 29,
    primaryIssue: 'Depression & Social Withdrawal',
    emergencyContactDetails: {
      name: 'Rahma Sari',
      phone: '+6293456789013',
      relationship: 'Ibu'
  ...
  },
  {
    ...
    phone: '+6281234567892',
    email: 'aisha.putri@email.com',
    hobbies: 'Membaca, Menari, Bermain Piano',
    maritalStatus: 'Single' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Budi Santoso - +6281234567893 (Ayah)',
    firstVisit: true,
    previousVisitDetails: '',
    assignedTherapist: 'multi-001',
    status: ClientStatusEnum.Consultation,
    ...
    progress: 20,
    notes: 'Klien mengalami kecemasan berlebihan saat ujian dan presentasi di sekolah. Orang tua melaporkan anak sering menangis sebelum ujian dan sulit tidur. Responsif terhadap teknik relaksasi.',
    province: 'DKI Jakarta',
    // Minor-specific fields
    isMinor: true,
    school: 'SD Negeri 1 Menteng',
    grade: 'Kelas 6',
    guardianFullName: 'Budi Santoso',
    guardianRelationship: 'Father' as const,
    guardianPhone: '+6281234567893',
    guardianAddress: 'Jl. Menteng Raya No. 45, Jakarta Pusat',
    guardianOccupation: 'Dokter Spesialis Anak',
    guardianMaritalStatus: 'Married' as const,
    guardianLegalCustody: true,
    guardianCustodyDocsAttached: true,
    // Legacy fields
    name: 'Aisha Putri Ramadhani',
    age: 13,
    primaryIssue: 'Test Anxiety & Performance Pressure',
    emergencyContactDetails: {
      name: 'Budi Santoso',
      phone: '+6281234567893',
      relationship: 'Ayah'
  ...
  },
  {
    ...
    hobbies: 'Sepak Bola, Bermain Game, Menggambar',
    maritalStatus: 'Single' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Dewi Sartika - +6282345678906 (Ibu)',
    firstVisit: false,
    previousVisitDetails: 'Pernah konsultasi di RS. Hasan Sadikin Bandung tahun 2023 untuk masalah ADHD',
    assignedTherapist: 'multi-001',
    status: ClientStatusEnum.Therapy,
    joinDate: '2024-01-20',
    totalSessions: 4,
    lastSession: '2024-02-10',
    progress: 60,
    notes: 'Klien dengan diagnosis ADHD ringan. Menunjukkan kemajuan signifikan dalam kemampuan fokus dan pengendalian impuls. Teknik behavioral therapy dan reward system efektif.',
    province: 'Jawa Barat',
    // Minor-specific fields
    isMinor: true,
    school: 'SD Negeri 3 Bandung',
    grade: 'Kelas 5',
    guardianFullName: 'Dewi Sartika',
    guardianRelationship: 'Mother' as const,
    guardianPhone: '+6282345678906',
    guardianAddress: 'Jl. Cihampelas No. 67, Bandung',
    guardianOccupation: 'Psikolog',
    guardianMaritalStatus: 'Divorced' as const,
    guardianLegalCustody: true,
    guardianCustodyDocsAttached: true,
    // Legacy fields
    name: 'Rafi Akbar Hidayat',
    age: 14,
    primaryIssue: 'ADHD & Attention Difficulties',
    emergencyContactDetails: {
      name: 'Dewi Sartika',
      phone: '+6282345678906',
      relationship: 'Ibu'
  ...
  },
  {
    ...
    education: ClientEducationEnum.Elementary,
    educationMajor: '',
    address: 'Jl. Darmo Permai No. 23, Surabaya',
    phone: '+6283456789014',
    email: 'nabila.zahra@email.com',
    hobbies: 'Menyanyi, Menari, Membaca Buku',
    maritalStatus: 'Single' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Ahmad Rizki - +6283456789015 (Ayah)',
    firstVisit: true,
    previousVisitDetails: '',
    assignedTherapist: 'multi-001',
    status: ClientStatusEnum.Assigned,
    ...
    lastSession: '',
    progress: 0,
    notes: 'Klien baru ditugaskan. Orang tua melaporkan anak mengalami kesulitan sosial di sekolah, sering di-bully, dan menunjukkan gejala depresi ringan. Perlu assessment awal.',
    province: 'Jawa Timur',
    // Minor-specific fields
    isMinor: true,
    school: 'SD Negeri 2 Surabaya',
    grade: 'Kelas 4',
    guardianFullName: 'Ahmad Rizki',
    guardianRelationship: 'Father' as const,
    guardianPhone: '+6283456789015',
    guardianAddress: 'Jl. Darmo Permai No. 23, Surabaya',
    guardianOccupation: 'Pengacara',
    guardianMaritalStatus: 'Married' as const,
    guardianLegalCustody: true,
    guardianCustodyDocsAttached: false,
    // Legacy fields
    name: 'Nabila Zahra Permata',
    age: 12,
    primaryIssue: 'Social Difficulties & Bullying',
    emergencyContactDetails: {
      name: 'Ahmad Rizki',
      phone: '+6283456789015',
      relationship: 'Ayah'
  ...
  {
    id: 'CLT019',
    fullName: 'Daffa Pratama Wijaya',
    gender: 'Male' as const,
    birthPlace: 'Yogyakarta',
    birthDate: '2008-07-12',
    religion: 'Islam' as const,
    occupation: 'Pelajar',
    education: ClientEducationEnum.JuniorHigh,
    educationMajor: '',
    address: 'Jl. Malioboro No. 89, Yogyakarta',
    phone: '+6284567890123',
    email: 'daffa.pratama@email.com',
    hobbies: 'Bermain Gitar, Futsal, Menulis Puisi',
    maritalStatus: 'Single' as const,
    spouseName: '',
    relationshipWithSpouse: undefined,
    emergencyContact: 'Siti Nurhaliza - +6284567890124 (Ibu)',
    firstVisit: false,
    previousVisitDetails: 'Pernah konsultasi di Klinik Psikologi UGM tahun 2023 untuk masalah kecemasan',
    assignedTherapist: 'multi-001',
    status: ClientStatusEnum.Therapy,
    joinDate: '2024-01-10',
    totalSessions: 6,
    ...
    progress: 75,
    notes: 'Klien dengan riwayat kecemasan sosial. Menunjukkan kemajuan luar biasa dalam kepercayaan diri dan kemampuan sosial. Teknik exposure therapy dan cognitive restructuring sangat efektif.',
    province: 'DI Yogyakarta',
    // Minor-specific fields
    isMinor: true,
    ...
    guardianRelationship: 'Mother' as const,
    guardianPhone: '+6284567890124',
    guardianAddress: 'Jl. Malioboro No. 89, Yogyakarta',
    guardianOccupation: 'Dosen Universitas',
    guardianMaritalStatus: 'Widowed' as const,
    guardianLegalCustody: true,
    guardianCustodyDocsAttached: true,
    // Legacy fields
    name: 'Daffa Pratama Wijaya',
    age: 15,
    primaryIssue: 'Social Anxiety & Self-Confidence',
    emergencyContactDetails: {
      name: 'Siti Nurhaliza',
      phone: '+6284567890124',
      relationship: 'Ibu'
